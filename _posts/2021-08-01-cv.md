...
* Ведение проектов заказчиков сегментов B2C, B2B, B2G.
* Навыки оформления рабочей и проектной документации в соответствии с требованиями ГОСТ.
* Экспертное знание Excel, VBA, Power Query, Power Pivot (MDX, DAX, M), Power BI.
* Уверенное владение SQL (диалект PL/SQL).
* Моделирование бизнес-процессов в нотациях BPMN 2.0, EPC, DFD, IDEF.
* Описание архитектуры информационных систем в UML, SysML, ArchiMate.
